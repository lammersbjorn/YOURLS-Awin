...
Suggested release notes for the current v3 line:
...
- Preserved existing `awin_affiliate_settings` compatibility.
- Added local Docker-based YOURLS development setup.
